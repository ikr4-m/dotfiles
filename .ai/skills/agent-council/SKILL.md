...
- `CLAUDE.md`, `AGENT.md`, `AGENTS.md`, `.ai/AGENT.md`, or `CONTRIBUTIONS.md` in the project root or workspace (business context, preferences, constraints)
- Any `memory/` folder or subsets of memory features (audience profiles, voice docs, business details, past decisions)
